...
<div class="header">
    <nav class="navbar navbar-dark bg-dark navbar-expand-md sticky-top">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="astaff.jsp"><i class="fa fa-plus"></i> Add new Staff</a>
        </li>
    </ul>
...
<fieldset class="jumbotron bg-transparent" style="border: 5px solid grey;">
  ...
  <form action="./astservlet" method="post" class="jumbotron bg-transparent" style="border:1px solid blue;border-radius:20px;">
    <div class="col-sm-6 mb-3 mb-sm-0">
      <label class="h5 text-primary" for="email">Email address:</label>
      <input name="stname" type="email" autocomplete="off" placeholder="e-mail" class="form-control" id="email" required>
    </div><br>
    <div class="col-sm-6 mb-3 mb-sm-0">
      <label class="h5 text-primary" for="pwd">Password:</label>
      <input name="stpass" type="password" autocomplete="off" placeholder="password" class="form-control" id="pwd" required>
    </div><br>
    <div class="col-sm-6 mb-3 mb-sm-0">
