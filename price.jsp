...
%>
<%
String q2="select available from floor1 where typeofshop='"+sp+"'";
...
%>
<%String uq="update floor1 set available=available-1 where typeofshop='"+sp+"'";
...
try {
		String query=" insert into bspacesf1(cmail,shoptype,units,bfrom,bto,price)"+" values (?, ?, ?, ?, ?,?)";
		stmt = con.prepareStatement(query);
		stmt.setString(1,un);
		stmt.setString(2, sp);
		stmt.setString(3, tc);
